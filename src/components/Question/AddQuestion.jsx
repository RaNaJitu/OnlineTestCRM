...
const AddQuestion = () => {
    ...
    const onInputChange = (e) => {
        ...
        // setQuestionPaper({...questionPaper,  options:[...questionPaper.options, {[e.target.name] : e.target.value}]});
        // setQuestionPaper({...questionPaper, options: [{ [ e.target.name]: e.target.value}]});
        // setQuestionPaper({...questionPaper, [e.target.name]: e.target.value, ...{options: [{ [ e.target.name]: e.target.value}]}});
        // setQuestionPaper({...questionPaper, [e.target.name]: e.target.value, option: [...{[ e.target.name]: e.target.value}, {[ e.target.name]: e.target.value}]});
          ...
          <form onSubmit={(e) => onSubmit(e)}>
            <div className="mb-3">
              <input
                ...
                onChange={(e) =>  setQuestionPaper({...questionPaper, question: e.target.value})}
              />
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
              <input
                ...
                name="opt1"
                // value={questionPaper.options.map((data) => ({ data }))}
            ...
            <button className="form-control btn-success">Add Question</button>
          </form>
        </div>
      </div>
    );
